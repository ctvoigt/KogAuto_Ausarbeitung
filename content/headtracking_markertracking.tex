...
Während die IMU-Orientierung in Weltkoordinaten berechnet wird, ist die Kameraorientierung in Fahrzeugkoordinaten angegeben.
Für die Fusion wird die Kameraorientierung deshalb in Weltkoordinaten überführt.
Für die Umsetzung wurde das TF-Framework von ROS verwendet.
Dadurch ist es möglich, das Fusionsergebnis in einem beliebigen Koordinatensystem anzugeben. Abb.~\ref{fig:tf_tree} zeigt den Transformationsbaum der Anwendung.
