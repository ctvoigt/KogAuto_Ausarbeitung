...
Um die Magnetometerdaten letzlich zur Stützung des Yaw-Winkels zu nutzen werden die Daten zuerst in das Weltkoordinatensystem transformiert. Danach wird das vorhandene Rotationsquaternion $q_{gyro,acc}$ mit dem $q_{mag}$ interpoliert. Das genaue Verfahren wird im nachfolgenden Abs. \ref{headtracking_fusion_subsec}  vorgestellt.