...
\todo{Absichtlich Umbruch mit Doppel-backslash?}
...
Sobald das Erdmagnetfeld nicht am Äquator gemessen wird, sondern im Falle unseres Praktikums\todo[inline]{TR: Ich hab mal eingebläut bekommen, dass "ich", "wir" etc. in so einer Ausarbeitung nix zu suchen haben. Mit Ausnahme des allerersten/-letzten Kapitels vielleicht. ;-)} bei etwa $49^\circ$ geographischer Breite, muss der Inklinationswinkel bei der Messung mit beachtet werden.
