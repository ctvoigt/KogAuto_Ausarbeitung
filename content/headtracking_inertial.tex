...
der Bias gemittelt \todo{Der Bias selbst wird nicht gemittelt. Er wird bestimmt durch den Mittelwert der während des Kalibriervorgangs anfallenden Daten.}, dieser wird nach Beendigung des Kalibriervorganges von den
