...
Hierdurch ergibt sich ein recht genaues, empirisch bestimmtes Ergebnis für die für das Verfahren verwendeten, virtuellen Brillenbildschirme: Siehe Tabelle \ref{tab:konstanteWerte}. \todo{diese Ref ist iwie fehlerhaft..}
\begin{table}[h]
 \begin{tabular}{l|l}
  Eigenschaft & Wert \\
  \hline
