...
\begin{figure}[h]
   ...
   \label{fig:3D}
\end{figure}
\todo{Hier bitte noch die Quelle angeben, die hat Ecaterina noch.}
...
Zusätzlich dazu werden 2 Kameras in der virtuellen Welt definiert, die permanent Sichtbilder\todo{Was für ein wort ist das?} auf die virtuellen Objekte ermöglichen. Allerdings reicht eine einfache Augensimulation aufgrund der technischen Voraussetzungen nicht aus. 
...
%
 ...
 \end{table}
\todo{hier müssen sich noch falsche werte in die tabelle eingeschlcihen haben, dass sind die werte von der größe, nicht von der dichte!}
