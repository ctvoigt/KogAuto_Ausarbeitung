...
\title{Abschlussbericht des Projektpraktikum\\ Kognitive Automobile }
%
%
...
Ecaterina X. 
 \\
Betreuer: Ralf Kohlhaas, Mark Zofka 
...
\input{content_einleitung}
\input{content_calibrierung}
\section{Headtracking}
\include{content_headtracking_sensorik}
\include{content_headtracking_fusion}
\include{content_headtracking_markertracking}
\include{content_headtracking_zusammenspiel}
\input{content_ende}
