...
% should be used if it is desired that the figures are to be displayed in6
% draft mode.
%
...
urlcolor={black},
pdftitle={Kognitive Automobile - Kalibrierung und Nutzung einer Durchsichtbrille},%<!CHANGE!
pdfsubject={Typesetting},%<!CHANGE!
pdfauthor={Christian Voigt, Maximilian...},%<!CHANGE!
...
\title{Kognitive Automobile\\ Vuzix: Headtracking vs. Objekteinblendung}
%
%
...
\author{Francesco Gerardi, Dimitrij Sarancin, Tobias Roth, Daniel Hammann, Johannes Bittner, Christian Vogt, Ecaterina X., Maximilian Baritz, Tam Nguyen, \\
Ralf Kohlhaas~\IEEEmembership{(FZI)}, 
        Mark Zofka~\IEEEmembership{(FZI)} 
...
% The paper headers
\markboth{Abschlussdokumentation/bericht des FZI-Projektpraktikums, März~2014}%
...
\begin{IEEEkeywords}
Headtracking, Calibration, Vuzix glasses, filtering, augmented reality, sensor fusion, orientation, pose, magnetometer, marker/tag tracking, loosely coupled, stereoscopic, ....
\end{IEEEkeywords}}
...
%\input{content_sample}

\input{content_anfang}
\input{content_calibrierung}
\input{content_headtracking}
\input{content_ende}
